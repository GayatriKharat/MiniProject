...
ratings_file = r"C:\Users\hp\OneDrive\Desktop\ml-1m\ml-1m\ratings.dat"
movies_file = r"C:\Users\hp\OneDrive\Desktop\ml-1m\ml-1m\movies.dat"
users_file = r"C:\Users\hp\OneDrive\Desktop\ml-1m\ml-1m\users.dat"
...
if visualization == "Distribution of Ratings by Genres and Years":
    ...
    sns.barplot(x=avg_ratings, y=genres, hue=genres, palette="cool", legend=False)
    ...
    for age_group, genre_ratings in age_group_avg_ratings.items():
        ...
        plt.figure(figsize=(10, 6))
        sns.barplot(x=avg_ratings, y=genres, palette="viridis", hue=genres, legend=False)
        plt.xlabel("Average Rating")
        plt.ylabel("Genre")
